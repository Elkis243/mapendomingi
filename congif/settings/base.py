"""
Django base settings for congif project.
...
MIDDLEWARE = [
    ...
    'app.middleware.AdminRobotsNoIndexMiddleware',
]
...
# Fuseau horaire RDC (Kinshasa, UTC+1). Est : Africa/Lubumbashi (UTC+2).
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'contact@mapendomingi.org')
CONTACT_EMAIL_TO = os.getenv('CONTACT_EMAIL_TO', DEFAULT_FROM_EMAIL)
CONTACT_SENDER_NAME = os.getenv('CONTACT_SENDER_NAME', 'MAPENDO MINGI')
